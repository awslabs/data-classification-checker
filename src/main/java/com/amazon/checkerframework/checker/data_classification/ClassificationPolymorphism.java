...
public class ClassificationPolymorphism extends DefaultQualifierPolymorphism {
    ...
    /**
     * Replaces {@code @PolyClassification} in {@code type} with the instantiations in {@code
     * replacements}. Replaces {@code @PolyClassification("use")} with the same annotation that
